...
namespace StudentRegistrationApplication
{
    public partial class Form1 : Form
    {
        ...
        private void showStudentInfo(string studentNames, string program)
        {
            string lastname = textBox1.Text;
            string Firstname = textBox2.Text;
            string middlename = textBox3.Text;
            ...
            string DateOfBirth = "Date of birth: " + dayBox.Text + "/" + monthBox.Text + "/" + yearBox.Text;
            string programs = "Program: " + program1.Text;
            MessageBox.Show(studentName + "\n" + program);
        }
        ...
        private void showStudentInfo(string studentNames, string program, string dateOfBirth, string gender)
        {
            string lastname = textBox1.Text;
            string Firstname = textBox2.Text;
            string middlename = textBox3.Text;
